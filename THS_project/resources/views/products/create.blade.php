            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="seuil_alerte" value="{{ old('seuil_alerte', $product->seuil_alerte ?? 50) }}" 
                ...
                <!-- Image -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Image du Produt</label>
