        ...
        <div class="lg:col-span-2 bg-white rounded-lg shadow p-6">
            ...
            <div id="produitsList" class="space-y-2 max-h-96 overflow-y-auto">
                ...
                <div class="produit-item flex items-center justify-between p-3 border rounded hover:bg-gray-50 cursor-pointer" 
                     ...
                     data-stock="{{ $product->stock_actuel }}">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">{{ $product->format }} - {{ number_format($product->prix_unitaire) }} FCFA</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-600">Stock: {{ $product->stock_actuel }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="border-t pt-4 space-y-2">
                ...
                <form method="POST" action="{{ route('ventes.store') }}" id="venteForm">
                    @csrf
                    <input type="hidden" name="products" id="produitsData">
