...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            addProducts($picture, $name, $price, $desc);
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <?php if ($success): ?>
            <div class="mb-6 bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded">
                ...
                <a href="/product.php" class="underline">Ajouter un autre produit</a>
            </div>
        <?php endif; ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"><?= htmlspecialchars($_POST['desc'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="picture" placeholder="images/product.jpeg" accept="image/*"
