...
<html lang="en">
    <head>
        ...
        <style>
            .login{
                background: url('{{ asset("./assets/images/reset2.jpg") }}');
        ...
        <div class="container mx-auto h-full flex flex-1 justify-center items-center">
            <div class="w-full max-w-xl">
                <div class="leading-loose">
                    <div class="max-w-xl mx-auto mt-10 p-10 bg-white shadow rounded">
                        <h2 class="text-lg font-semibold mb-4">New Password</h2>
                        ...
                        <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
                            ...
                            {{-- Envoi du token de reinitialisation via url --}}
                            ...
                            <button type="submit"
                                    class="w-full bg-blue-500 mt-3 text-white py-2 rounded hover:bg-blue-600">
                                Reset Password
                            </button>
                        </form>
                    </div>
