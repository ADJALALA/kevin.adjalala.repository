    ...
    <nav class="bg-white shadow">
        <div class="container mx-auto px-6">
            <div class="flex space-x-1">
                ...
                <a href="{{ route('produits.index') }}" class="flex items-center gap-2 px-6 py-4 font-medium transition {{ request()->routeIs('produits.*') ? 'text-yellow-600 border-b-2 border-yellow-600' : 'text-gray-600 hover:text-yellow-600' }}">
