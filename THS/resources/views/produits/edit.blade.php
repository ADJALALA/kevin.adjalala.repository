            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="seuil_alerte" value="{{ old('seuil_alerte', $produit->seuil_alerte) }}" 
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600">{{ $produit->stock_actuel }} unités</p>
                ...
                <div>
                    ...
                    @if($produit->image)
                        <img src="{{ asset('storage/' . $produit->image) }}" class="w-32 h-32 object-cover rounded mb-2">
                    @endif
